...
public class TripAdvisorAPI implements API {
    ...
    public TripAdvisorAPI() {
        ...
        Room room2 = new Room(2L, 200, 2, date2, "Opera Hotel", "Kiev");
        Room room3 = new Room(3L, 300, 2, date3, "GrandHotel", "Paris");
        Room room4 = new Room(4L, 500, 2, date4, "GrandHotel", "Las Vegas");
        Room room5 = new Room(5L, 200, 2, date5, "ParisStar", "Paris");
